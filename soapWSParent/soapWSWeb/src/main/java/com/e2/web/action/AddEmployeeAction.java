...
public class AddEmployeeAction extends ActionSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (employeeInfoForm.getWorkPhoneNumber() != null && employeeInfoForm.getWorkPhoneNumber().length() != 0) {
...
//				employeeInfoService.addPhone(workPhone);
			...
			if (employeeInfoForm.getHomePhoneNumber() != null && employeeInfoForm.getHomePhoneNumber().length() != 0) {
...
//				employeeInfoService.addPhone(homePhone);
			...
			if (employeeInfoForm.getMobilePhoneNumber() != null && employeeInfoForm.getMobilePhoneNumber().length() != 0) {
				Phone mobilePhone = new Phone();
				mobilePhone.setPhoneNumber(employeeInfoForm.getMobilePhoneNumber());
